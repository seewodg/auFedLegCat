...
#    "catalogTarget": "https://www.legislation.gov.au/search/text(%22location%20spatial%20area%22,nameAndText,all)/status(InForce)/pointintime(Latest)/collection(Act,AdministrativeArrangementsOrder,LegislativeInstrument)/sort(searchcontexts%2Ftext%2Frelevance%20desc)"
